#ifndef TOY_CNN_SDK_UTILS_DIMENSION_HPP__
#define TOY_CNN_SDK_UTILS_DIMENSION_HPP__
...
public:
    ...
    {}
    Dimension(const Dim &inDim)
        : Dimension(inDim.x, inDim.y, inDim.z, inDim.w)
    {}
...
#endif // TOY_CNN_SDK_UTILS_DIMENSION_HPP__
